...
if button_clicked:
    try:
        ...
        st.error('This company is not listed in NYSE, please try another one', icon="🚨")
    if (get_info.info['totalRevenue'] is not None):
        ...
        st.error('This company has no financial information, please try another one!', icon="🚨")
